...
*/
  ...
  onHandleSave = async () => {
    ...
    const vistoriaInput = {
      ...
      horimetroChegada: this.state.horimetroChegada * 10,
    ...
    return (
      <View>
        ...
        <InputWithTitle
          ...
          height={22}
          size={160}
          value={`${!this.props.getCliente.loading ? this.props.getCliente.clienteById.name : ''}`}
        />
        <InputWithTitle
          title="Frota"
          editable={false}
          height={22}
          size={160}
          value={`${!this.props.getFrota.loading ? this.props.getFrota.frotaById.name : ''}`}
        />
        <View
          style={{
            flexDirection: 'row',
        ...
        >
          <InputWithTitle
            ...
            height={22}
            size={78}
            value={`${!this.props.data.loading ? this.props.data.vistoriaById.dtSaida : ''}`}
          />
          <InputWithTitle
            title="Hora Saída"
            editable={false}
            height={22}
            size={78}
            value={`${!this.props.data.loading ? this.props.data.vistoriaById.hrSaida : ''}`}
          />
        </View>
        <View
          style={{
        ...
        >
          <InputWithTitle
            ...
            height={22}
            size={78}
            value={`${!this.props.data.loading ? this.props.data.vistoriaById.horimetroSaida : ''}`}
          />
          <InputWithTitle
            title="Horímetro/Km"
            size={78}
            ...
            onChangeText={value =>
              this.handleInputNumeric ('horimetroChegada', value, true)}
            value={returnValueMasked (this.state.horimetroChegada, 1)}
          />
        </View>
